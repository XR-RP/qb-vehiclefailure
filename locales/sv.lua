local Translations = {
    error = {
        ...
        ["out_range_veh"] = "Du är för långt ifrån fordonet!",
        ["inside_veh"] = "Du kan inte reparera motorn ifrån insidan!",
        ...
        ["nofix_message_4"] = "Du höjde radion. Det konstiga motorljudet är nu borta",
